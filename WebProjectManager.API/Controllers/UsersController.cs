    ...
    public class UsersController : Controller
    {
        ...
        public async Task<object> Login([FromBody] LoginViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var jwtToken = GenerateJwt(existingUser.Email, existingUser);
            ...
            if (userRequest.PhoneNumberConfirmed == false)
            {
                ...
                if (checkExists.Count == 0)
                {
                    ...
                    var message = MessageResource.Create(
                        ...
                        from: new Twilio.Types.PhoneNumber("+19128006129"),
...
*/
        ...
        private Task<string> GenerateJwt(string email, User user)
        {
